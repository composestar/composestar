...
public abstract class ProgramElement extends PlatformRepresentation implements SerializableRepositoryEntity
{
	...
	/*
	  ...
	  /**
	   * @param attribute A standard attribute, such as private/public/protected/synchronized/etc.
	   * @return whether this program element has the specified attribute.
	   */
	  public abstract boolean hasUnitAttribute(String attribute);
	  
	  /**
	   * @return collection of all (standard) attributes attached to this program element.
	   */
	   ...
	   * @returns UnitResult, containing one or more references to other ProgramElements
	   */
