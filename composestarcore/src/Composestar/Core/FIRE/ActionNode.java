...
/////// Selector /////////////
        ...
        public String getPreferedSelector () {return preferedSelector;}
...
/////// Conditions /////////////
	...
	public void setConditions (Symbol [] conditionArray)
	{
        ...
        protected Symbol stringToSymbol (String symbolString, int symbolType)
        {
                ...
                {
                	//System.out.println ("Returning star instead of symbol: " + symbolString);
	...
	public void addSymbol (Symbol s)
	{
		switch (s.getType())
		{
			case 0: conditions.add(s); break;
			case 1: setTarget(s); break;
			case 2: setSelector(s); break;
            default: throw new RuntimeException("FIRE.addSymbol:Symbol type not known " + s.toString());
		}
	}
