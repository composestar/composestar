...
namespace Trese.ComposestarProject
{
	...
	[ProvideProjectFactory(typeof(ComposestarProjectFactory), "Composestar", "Composestar Project Files (*.cpsproj);*.cpsproj", "cpsproj", "cpsproj", ".\\NullPath", LanguageVsTemplate = "Composestar")]
	...
	public class ComposeStarProjectNode : Microsoft.VisualStudio.Package.ProjectNode, IVsProjectSpecificEditorMap2 //, IVsFilterAddProjectItemDlg2 
	{
		...
		public string OutputFileName
		{
			...
			{/*
				...
				*/
				return null; // assemblyName + GetOutputExtension(outputType);
		...
		{
			return false; // String.Compare(type, BuildAction.Concern.ToString(), StringComparison.OrdinalIgnoreCase) == 0 || base.IsItemTypeFileType(type);
		}
