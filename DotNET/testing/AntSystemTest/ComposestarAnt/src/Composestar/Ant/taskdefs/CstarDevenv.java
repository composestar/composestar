...
public class cstarDevenv extends Task {
	...
	protected void compileSolution(String solution) throws BuildException {
		...
		String command = "\""+devenv+"\" \""+solution+"\" /command \""+COMPOSESTAR_BUILD+" "+BUILDLOG_NAME+"\"";
		...
		try {
			...
			if (failOnFirstError) {
				...
				getProject().log(this, "Compilation of solution "+solution+" failed; "+e.getMessage(), Project.MSG_ERR);
			}
		}
	}
}
