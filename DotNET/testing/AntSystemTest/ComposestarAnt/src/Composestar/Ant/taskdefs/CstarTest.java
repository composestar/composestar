...
public class cstarTest extends Task {
	...
	public void execute() throws BuildException {
		...
		getProject().log(this, ""+cntTotal+" test(s); success: "+cntSuccess+"; failed: "+cntFail+"; ratio: "+(cntSuccess*100/cntTotal)+"%", Project.MSG_INFO);
	...
	protected void runTest(String exec) throws BuildException {
		...
		try {
            ...
            BufferedReader correctFile = new BufferedReader(new FileReader(execPath.getParent()+File.separator+CORRECT_OUTPUT));
