...
public class DotNETLanguageModel extends LanguageModel
{
	...
	public void createMetaModel() throws InvalidModelException
	{
		...
		mcClass = Composestar.DotNET.LAMA.DotNETType.class;
		mcInterface = Composestar.DotNET.LAMA.DotNETType.class;
		mcType = Composestar.DotNET.LAMA.DotNETType.class;
		mcMethod = Composestar.DotNET.LAMA.DotNETMethodInfo.class;
		mcField = Composestar.DotNET.LAMA.DotNETFieldInfo.class;
		mcParameter = Composestar.DotNET.LAMA.DotNETParameterInfo.class;
		mcAnnotation = Composestar.DotNET.LAMA.DotNETType.class;
