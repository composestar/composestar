	...
	public class Connect : Object, Extensibility.IDTExtensibility2, IDTCommandTarget
	{
		...
		private void UpdateStatus(string commandName, ref EnvDTE.vsCommandStatus status) 
		{
			...
			else if (commandName == m_commandNameBuild)
			{
				...
				if (m_referenceBuildCommand.IsAvailable && (!m_referenceCancelBuildCommand.IsAvailable | commandName == m_commandNameClean)) 
					status = (vsCommandStatus)vsCommandStatus.vsCommandStatusSupported | vsCommandStatus.vsCommandStatusEnabled;
				else 
		...
		private void CreateToolBar() 
		{
            ...
            catch (ArgumentException)
            {
                ...
                m_Bar = ((Microsoft.VisualStudio.CommandBars._CommandBars)applicationObject.CommandBars).Add(commandBarValue, Microsoft.VisualStudio.CommandBars.MsoBarPosition.msoBarTop, null, null);
            }
			m_Bar.Visible = true;
		...
		private void AddCommandToToolbar(EnvDTE.Command command, string buttonText, string toolTip, bool beginGroup) 
		{
            ...
            Microsoft.VisualStudio.CommandBars.CommandBarButton commandBarButton = (Microsoft.VisualStudio.CommandBars.CommandBarButton)m_Bar.FindControl(Microsoft.VisualStudio.CommandBars.MsoControlType.msoControlButton, null, command.Name, null, true);
			...
			if (commandBarButton == null) 
			{
                ...
                commandBarButton.Style = Microsoft.VisualStudio.CommandBars.MsoButtonStyle.msoButtonAutomatic;
		...
		/// </returns>
        private Microsoft.VisualStudio.CommandBars.CommandBarButton AppendControl(EnvDTE.Command command, string buttonText, string toolTip, Microsoft.VisualStudio.CommandBars.CommandBar commandBar) 
		{
            Microsoft.VisualStudio.CommandBars.CommandBarButton commandBarButton = (Microsoft.VisualStudio.CommandBars.CommandBarButton)command.AddControl(commandBar, commandBar.Controls.Count + 1);
		...
		private void AddCommandToMenubar(EnvDTE.Command command, string buttonText, string toolTip, bool beginGroup) 
		{
            ...
            Microsoft.VisualStudio.CommandBars._CommandBars commandBars = (Microsoft.VisualStudio.CommandBars.CommandBars)applicationObject.CommandBars;
            Microsoft.VisualStudio.CommandBars.CommandBar menuBar = commandBars.ActiveMenuBar;
			// search if command is already available
            Microsoft.VisualStudio.CommandBars.CommandBarControl menuItem = menuBar.FindControl(Microsoft.Office.Core.MsoControlType.msoControlButton, null, command.Name, null, true);
			if (menuItem == null) 
			{
                Microsoft.VisualStudio.CommandBars.CommandBarPopup vcbPopupBar = (Microsoft.VisualStudio.CommandBars.CommandBarPopup)m_Menu;
                Microsoft.VisualStudio.CommandBars.CommandBar vcbCommandBar = (Microsoft.VisualStudio.CommandBars.CommandBar)vcbPopupBar.CommandBar;
		...
		{
            Microsoft.VisualStudio.CommandBars._CommandBars commandBars = (Microsoft.VisualStudio.CommandBars.CommandBars)applicationObject.CommandBars;
            Microsoft.VisualStudio.CommandBars.CommandBar commandBar = (Microsoft.VisualStudio.CommandBars.CommandBar)commandBars[toolbarName];
            Microsoft.VisualStudio.CommandBars.CommandBarControl commandBarControl = commandBar.FindControl(Microsoft.VisualStudio.CommandBars.MsoControlType.msoControlButton, null, tag, null, true);
		...
		private void DeleteCommandFromMenubar(string tag) 
		{
            Microsoft.VisualStudio.CommandBars._CommandBars commandBars = (Microsoft.VisualStudio.CommandBars.CommandBars)applicationObject.CommandBars;
            Microsoft.VisualStudio.CommandBars.CommandBar menuBar = commandBars.ActiveMenuBar;
            Microsoft.VisualStudio.CommandBars.CommandBarControl addinMenuItem = menuBar.FindControl(Microsoft.VisualStudio.CommandBars.MsoControlType.msoControlButton, null, tag, null, true);
