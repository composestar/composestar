...
A default Abstraction and Implementor is used. The concern Bridge overrides the used Implementor based on the value of a condition. This shows that Compose* can change the Implementor without changing existing code.