...
A default Abstraction and Implementor is used. The concern Bridge overrides the used Implementor based on a random value. This shows that Compose* can change the Implementor without changing existing code.