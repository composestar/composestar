...
import Composestar.Core.CpsRepository2.SuperImposition.SelectorTestBase;
...
public abstract class AbstractSelectorTestBase extends SelectorTestBase
{
	...
	/**
	 * Test method for
	 * {@link Composestar.Core.CpsRepository2Impl.SuperImposition.AbstractSelector#setSelection(java.util.Collection)}
	 * .
	 */
