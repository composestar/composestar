 ...
 */
public abstract class CpsProgramElementTestBase extends TestCase
{
	protected Type pe;

	protected CpsProgramElement cpe;
	...
	{
		super.setUp();
		pe = new DummyTPE("foo.bar.quux");
	}

	/**
	 * Test method for
	 * {@link Composestar.Core.CpsRepository2.TypeSystem.CpsProgramElement#getProgramElement()}
	 * .
	 */
	public void testGetProgramElement()
	{
		assertSame(pe, cpe.getProgramElement());
	}
