...
public final class INIFile
{
	 ...
	 * @param pblnGMT If true formats the string using GMT timezone otherwise
	...
	{
	/*
	 * INIFile objINI = null; String strFile = null; if (pstrArgs.length == 0)
	 * return; strFile = pstrArgs[0]; // Following call will load the strFile if
	 * one exists. objINI = new INIFile(strFile); //
	 * objINI.addSection("QADatabase", "QA database connection details\nUsed for
	 * QA Testing"); // objINI.setStringProperty("QADatabase", "SID", "ORCL",
	 * null); // objINI.setStringProperty("QADatabase", "UserId", "System",
	 * null); // objINI.setStringProperty("QADatabase", "Password", "Manager",
	 * null); // objINI.setStringProperty("QADatabase", "HostName", "DBServer",
	 * null); // objINI.setIntegerProperty("QADatabase", "Port", 1521, null); //
	 * objINI.setStringProperty("QADatabase", "OracleHome", "%ORACLE_HOME%",
	 * null); // // objINI.setSectionComments("Folders", "Directories where
	 * generated files are stored"); // objINI.setStringProperty("Folders",
	 * "folder1", "G:\\Temp", null); // objINI.setStringProperty("Folders",
	 * "folder2", "G:\\Temp\\Backup", null); // Save changes back to strFile.
	 * objINI.save(); objINI = null;
	 */
	}
