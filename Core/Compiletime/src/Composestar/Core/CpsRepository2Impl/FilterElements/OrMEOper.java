...
/**
 * Or matching expression operators. Either value should return true for this
 * operator to be true.
 * 
 * @author Michiel Hendriks
 */
public class OrMEOper extends AbstractRepositoryEntity implements BinaryMEOperator
{
