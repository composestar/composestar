 ...
 */
public abstract class StructuralConstraint extends BinaryConstraint
{
	 ...
	 */
	protected StructuralConstraint(String type, FilterModuleConstraintValue lhsValue,
			FilterModuleConstraintValue rhsValue) throws NullPointerException, IllegalArgumentException
	{
