 ...
 *
 * $Id: SuperImposition.java,v 1.3 2006/02/16 12:51:22 composer Exp $
 */
...
public class SuperImposition extends DeclaredRepositoryEntity {
  ...
  /**
   * @return vector (.NET doesn't allow Collection) of AnnotationBinding objects attached to this superimposition part
   */
