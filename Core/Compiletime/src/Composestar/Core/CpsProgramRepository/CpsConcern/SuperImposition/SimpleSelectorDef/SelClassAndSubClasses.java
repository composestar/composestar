...
public class SelClassAndSubClasses extends SimpleSelExpression
{
	 ...
	 * and all those marked as 'subclasses': the interpretation of 'subclass'
	 * is: - all .NET classes that are marked as being a subclass - all concerns
	 * that dispatch to this class as an internal (..) *if* they are also a
	 * subtype TODO currently, only returns the class itself, and no subclasses!
	 * 
