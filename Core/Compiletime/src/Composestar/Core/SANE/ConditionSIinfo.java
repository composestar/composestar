...
public class ConditionSIinfo extends Composestar.Core.RepositoryImplementation.ContextRepositoryEntity implements AbstractSIinfo {
    /**
	 * 
	 */
     ...
     * @param name
     * @return 
     * Composestar.Core.CpsProgramRepository.CpsConcern.Filtermodules.Condition
