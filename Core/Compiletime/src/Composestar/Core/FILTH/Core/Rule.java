...
public abstract class Rule {
	...
	public Parameter getLeft(){ return _left; }
	public Parameter getRight(){ return _right; }
	
	public void insert(Graph g){
		g.addEdge(new Edge(getIdentifier(),
							Action.lookup((Action)this.getLeft(),g),
							Action.lookup((Action)this.getRight(),g))
				  );
	}
