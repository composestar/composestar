...
{
	/**
	 * The method does not need a join point context. A method with either
	 * zero or one argument is accepted. Preference goes to the zero
	 * argument method.
	 */
	UNUSED,
	/**
	 * The method uses the lightweight join point context. All information
	 * of the partial context is also included in the full context.
	 */
	PARTIAL,
	/**
