...
public class LanguageUnitType
{
	...
	private boolean  nameUnique;    // Whether the name of this kind of unit should be unique
	private Hashtable relationTypes;// Specs of relations that this type of unit can have to other units
	...
	/*
	public void setImplementingClass(Class impl)
	{
		this.impl = impl;
	}*/
	 ...
	 * @param argument This unit type is the Nth argument of this relation (start counting at 0) 
	 */
