...
public class HighLevelInliner
{
	...
	// }
	//
	// private void inline(List<FilterModuleBlock> blocks, FilterModule[]
	// modules, MethodInfo method)
	// {
	...
	// {
	// strategy.startFilterModule((FilterModule)
	// fmBlock.fmState.getFlowNode().getRepositoryLink());
	//
	...
	// {
	// Iterator<FilterElementBlock> filterElements =
	// filterBlock.filterElements.iterator();
	//
	...
	// }
	//
	// private void inlineFilterElements(Iterator<FilterElementBlock>
	// filterElements)
	// {
	...
	//
	// strategy.openBranchTrue((MatchingExpression)
	// condExprFlowNode.getRepositoryLink());
	//
	// strategy.generateAction(flowTrueExitState);
	//
	...
	// }
	//
	// private List<FilterModuleBlock> identifyFilterModuleBlocks(ExecutionModel
	// model)
	// {
	...
	// }
	//
	// private ExecutionState identifyFilterElementBlocks(ExecutionState
	// filterState, FilterBlock filterBlock)
	// {
	...
	// }
	//
	// private FilterElementBlock identifyFilterElementBlock(ExecutionState
	// condExpr)
	// {
	...
	//
	// if
	// (transition.getLabel().equals(ExecutionTransition.CONDITION_EXPRESSION_TRUE))
	// {
	...
	// * starting with the given state. This exitState is either an actionstate
	// or
	...
	// currentState.getOutTransitionsEx().get(0);
	...
	// state.getFlowNode().containsName(FlowNode.ACTION_NODE);
	// }
	//
	...
	// MatchingExpression expr2 = (MatchingExpression)
	// flowNode.getRepositoryLink();
	//
	// if
	// (transition.getLabel().equals(ExecutionTransition.CONDITION_EXPRESSION_FALSE))
	// {
	// Not not = new Not();
