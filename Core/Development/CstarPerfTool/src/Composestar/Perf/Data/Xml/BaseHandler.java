...
public abstract class BaseHandler extends DefaultHandler
{
	 ...
	 */
	protected static InputStream getInputStream(File file) throws IOException
	{
	...
	public BaseHandler(XMLReader inReader, DefaultHandler inParent)
	{
		super();
		reader = inReader;
		parent = inParent;
		charData = new StringBuffer();
		if (parent instanceof BaseHandler)
		{
			setDocumentLocator(((BaseHandler) parent).locator);
		}
	}
