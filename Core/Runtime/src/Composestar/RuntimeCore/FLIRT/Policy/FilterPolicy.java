 ...
 * FilterPolicy.java 2072 2006-10-15 12:44:56Z elmuerte $ Models the Way
 * messages are filtered. This deals with the way messages are handled within a
 * FilterModule.
 */
public abstract class FilterPolicy
{
	...
	/**
	 * Returns the default FilterPolicy Works as a factory method.
	 * 
