 ...
 * Message.java 2273 2006-10-25 12:33:20Z marcusk $ Models the Message as it is
 * being Filtered Keeps the name and arguments of the message. It also keeps
 * some of the pseudo variables necessary during filtering (for example
...
public class Message
{
	 ...
	 * until a return value or an executable action is written to the same
	 * buffer
	 */
	...
	/**
	 * Constructs a Message from its selector It is supposed that no arguments
	 * are set.
	 * 
	 * @param selector selector of the message
	 ...
	 * for manipulation inside an ACT.
	 * 
