 ...
 * MessageList.java 2072 2006-10-15 12:44:56Z elmuerte $ Models the Message as
 * it is being Filtered Keeps the name and arguments of the message. It also
 * keeps some of the pseudo variables necessary during filtering (for example
 * internals and externals). Finally it is responsible for producing a Reified
 * message of itself for the ACT's in the meta filter.
 */
public class MessageList
{
	 ...
	 */
	/*
	 * NOTE: use Message.OUTGOING and Message.INCOMING public static final int
	 * OUTGOING = 0; public static final int INCOMING = 1;
	 */
	...
	/**
	 * Reifies this message. It produces a version of this message that is fit
	 * for manipulation inside a ACT.
	 * 
	 ...
	 */
	/*
	 * public String getSelector() { return getOrgMessage().getSelector(); }
	 */
	 ...
	 */
	/*
	 * public void setSelector(String s) { getOrgMessage().setSelector( s ); }
	 */
	...
	/**
	 * Original Sender of the message -as os this version this is not used due
	 * to constraints of the message interception layer
	 */
	...
	/*
	 * public void setTarget(Object target) { getOrgMessage().setTarget( target ); }
	 * public Object getTarget() { return getOrgMessage().getTarget(); }
	 */
	...
	public void replace(MessageList ml)
	{
		...
		// "\nLastmatch: " + lastmatch );
		// if(Debug.SHOULD_DEBUG) Debug.out(Debug.MODE_DEBUG,"FLIRT","This: " +
		// this.toShortString() );
		// if(Debug.SHOULD_DEBUG) Debug.out(Debug.MODE_DEBUG,"FLIRT","Other: " +
		// ml.toShortString() );
		...
		// if(Debug.SHOULD_DEBUG) Debug.out(Debug.MODE_DEBUG,"FLIRT","This after
		// removal: " + this.toShortString() );
