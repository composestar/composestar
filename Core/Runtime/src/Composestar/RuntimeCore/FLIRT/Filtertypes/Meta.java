 ...
 * Meta.java 1518 2006-09-20 13:13:30Z reddog33hummer $ Models the Meta filter
...
public class Meta extends FilterTypeRuntime
{
	...
	public ComposeStarAction acceptAction(MessageList originalMessage, MessageList modifiedMessage, Dictionary context)
	{
		...
		return new MetaAction(originalMessage, originalMessage.reify(), modifiedMessage.getFirstMessage().getTarget(),
				modifiedMessage.getFirstMessage().getSelector(), true);
	}
