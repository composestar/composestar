 ...
 * Prepend.java 2012 2006-10-12 12:56:38Z reddog33hummer $ Models the Meta
 * filter If a message is accepted, it is reified and offered to a method
 * defined in the filter specification. if the message is rejected, it is passed
