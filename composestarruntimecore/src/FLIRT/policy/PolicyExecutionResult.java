 ...
 * $Id: PolicyExecutionResult.java,v 1.2 2006/02/13 12:01:32 composer Exp $
 * 
 * Models the Result of the execution of a FilterPolicy.
 * It says if the message should continue to the next filtermodule, the last 
 * action taken,
 * and a stack of the ACT callbacks collected by the sent messages in the Meta 
 * Filters
 */
public class PolicyExecutionResult {
     ...
     * @param shouldContinue says if the message should continue to the next filter.
     * @param actionResult  the result of the last action taken
     * @param stack stack of callbacks
     * @roseuid 3F3653310057
     */
    public PolicyExecutionResult(boolean wasAccepted, boolean shouldContinue, Object actionResult) { //, ComposestarStack stack) {
