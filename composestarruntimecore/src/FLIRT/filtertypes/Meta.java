 ...
 * $Id: Meta.java,v 1.5 2006/02/13 13:25:11 pascal Exp $
 * 
...
public class Meta extends FilterTypeRuntime implements DebuggableMetaFilterType
{
    ...
    public ComposeStarAction acceptAction(MessageList originalMessage, MessageList modifiedMessage, Dictionary context) {
		...
		{
			//originalMessage.getP
			//TODO Make this hand of the message to a the object manager
			//ObjectManager.getObjectManagerFor(modifiedMessage.getInner(),MessageHandlingFacility.datastore).deliverMessage(modifiedMessage);
		...
		return new MetaAction(originalMessage, originalMessage.reify(), modifiedMessage.getTarget(), modifiedMessage.getSelector(), true);     
    }
