package Composestar.Runtime.CODER.BreakPoint;

import Composestar.Runtime.CODER.BreakPointListener;
import Composestar.Runtime.CODER.Halter;
import Composestar.Runtime.CODER.StateHandler;
import Composestar.Runtime.CODER.model.DebuggableFilter;
import Composestar.Runtime.CODER.model.DebuggableMessage;
import Composestar.Runtime.CODER.Value.Value;
 ...
 */
public abstract class BreakPointValueOperator extends BreakPoint implements Value
{
	...
	public BreakPointValueOperator(Halter halt, Value left, Value right)
	{
		super(halt);
		this.left = left;
		this.right = right;
	...
	public int compareTo(Object o)
	{
		...
		{
			int comp = ((Value)o).compareTo(value());
			//inverse
			if(comp == 0)
			{
				return 0;
