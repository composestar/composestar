    ...
    public class BabelPackage : Microsoft.VisualStudio.Shell.Package, IOleComponent
	{
		...
		public BabelPackage()
		{
			ServiceCreatorCallback callback = new ServiceCreatorCallback(
				...
				{
					if (typeof(Composestar.StarLight.VisualStudio.LanguageServices.ComposeStarLangServ) == serviceType)
					{
                        Composestar.StarLight.VisualStudio.LanguageServices.ComposeStarLangServ language = new Composestar.StarLight.VisualStudio.LanguageServices.ComposeStarLangServ();
            ...
            (this as IServiceContainer).AddService(typeof(Composestar.StarLight.VisualStudio.LanguageServices.ComposeStarLangServ), callback, true);
		}
		...
		{
            BabelLanguageService ls = GetService(typeof(Composestar.StarLight.VisualStudio.LanguageServices.ComposeStarLangServ)) as BabelLanguageService;
