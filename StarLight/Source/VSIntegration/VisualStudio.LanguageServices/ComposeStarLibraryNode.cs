...
namespace Composestar.StarLight.VisualStudio.LanguageServices {
    ...
    /// <summary>
    /// This is a specialized version of the LibraryNode that handles the ComposeStar's
    ...
    /// </summary>
    internal class ComposeStarLibraryNode : LibraryNode {
        private IVsHierarchy ownerHierarchy;
        private uint fileId;
        private TextSpan sourceSpan;
        private string fileMoniker;

        internal ComposeStarLibraryNode(string namePrefix, IVsHierarchy hierarchy, uint itemId) :
            base("") {
        ...
        protected override LibraryNode Clone() {
            return new ComposeStarLibraryNode(this);
        }
