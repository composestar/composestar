...
namespace Composestar.StarLight.VisualStudio.Project
{
	...
	public class ComposeStarProjectNode : Microsoft.VisualStudio.Package.ProjectNode, IVsProjectSpecificEditorMap2 //, IVsFilterAddProjectItemDlg2 
	{
		...
		/// <summary>
		/// Gets the type of the specific editor.
		/// </summary>
		/// <param name="mkDocument">The mk document.</param>
		/// <param name="guidEditorType">Type of the GUID editor.</param>
		/// <returns></returns>
		...
		/// <summary>
		/// Gets the specific language service.
		/// </summary>
		/// <param name="mkDocument">The mk document.</param>
		/// <param name="guidLanguageService">The GUID language service.</param>
		/// <returns></returns>
		...
		/// <summary>
		/// Sets the specific editor property.
		/// </summary>
		/// <param name="mkDocument">The mk document.</param>
