...
namespace Composestar.StarLight.VisualStudio.LanguageServices {
    ...
    public class ComposeStarDeclarations : Declarations {
        ...
        public ComposeStarDeclarations(IList<Declaration> declarations, LanguageService langService)             
            : base() {
        ...
        public override string OnCommit(IVsTextView textView, string textSoFar, char commitCharacter,
                                        int index, ref TextSpan initialExtent) {
