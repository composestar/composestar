...
namespace SourceGrid.Cells.Controllers
{
    ...
    public class Resizable : ControllerBase
    {
        ...
        /// </summary>
        public DevAge.Drawing.RectangleBorder LogicalBorder = new DevAge.Drawing.RectangleBorder(new DevAge.Drawing.Border(System.Drawing.Color.Black, 4), new DevAge.Drawing.Border(System.Drawing.Color.Black, 4));
        ...
        public override void OnMouseDown(CellContext sender, MouseEventArgs e)
        {
            ...
            DevAge.Drawing.RectanglePartType partType = LogicalBorder.PointToPartType(l_CellRect, mousePoint, out mDistanceFromBorder);
        ...
        public override void OnMouseMove(CellContext sender, MouseEventArgs e)
        {
            ...
            int dummy;
            DevAge.Drawing.RectanglePartType partType = LogicalBorder.PointToPartType(cellRect, mousePoint, out dummy);
            ...
            if (sender.Grid.MouseDownPosition == sender.Position)
            {
                if (m_IsWidthResize)
                {
                    ...
                    if (newWidth > 0)
                        SetWidth(sender.Grid, sender.Position, newWidth + mDistanceFromBorder);
                ...
                else if (m_IsHeightResize)
                {
                    ...
                    if (newHeight > 0)
                        SetHeight(sender.Grid, sender.Position, newHeight + mDistanceFromBorder);
        ...
        public override void OnDoubleClick(CellContext sender, EventArgs e)
        {
            ...
            int distance;
            DevAge.Drawing.RectanglePartType partType = LogicalBorder.PointToPartType(cellRect, currentPoint, out distance);
        ...
        private int mDistanceFromBorder = 0;
