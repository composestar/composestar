...
namespace SourceGrid.Cells.Controllers
{
	...
	public interface IController
	{
		...
		/// <param name="e"></param>
		void OnContextMenuPopUp(CellContext sender, ContextMenuEventArgs e);
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void OnSelectionAdding(CellContext sender, RangeRegionChangingEventArgs e);
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void OnSelectionAdded(CellContext sender, RangeRegionEventArgs e);
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void OnSelectionRemoving(CellContext sender, RangeRegionChangingEventArgs e);
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		void OnSelectionRemoved(CellContext sender, RangeRegionEventArgs e);
