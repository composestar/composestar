...
namespace SourceGrid
{
	...
	public class RangeRegion
	{
		...
		//N.B. Il codice di questa classe è scritto in maniera tale da non avere mai sovrapposizioni. Quindi una cella potrà essere contenuta in un solo range. Nel caso vengano inseririti range sovrapposti questi vengono spezzati e reinseriti.
		...
		{
			RangeCollection ranges = new RangeCollection(m_RangeCollection);
