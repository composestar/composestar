...
namespace Purple.Graphics.VertexStreams {
  ...
  /// </remarks>
  //=================================================================
  public class PositionStream4 : GraphicsStream, IVertexStream{
    //---------------------------------------------------------------
    #region Variables
    //---------------------------------------------------------------
    static string name = "Position4";
    /// <summary>
    ...
    static public void Bind() {
      StreamFactory.Instance.Bind(name, typeof(PositionStream4), defaultElement);
    }
    ...
    public PositionStream4(VertexUnit vertexUnit) : base(vertexUnit.Size) {
    ...
    public PositionStream4(int size) : base(size) {
    }
    ...
    public static PositionStream4 From(VertexUnit unit, int index) {
      return (PositionStream4)unit[typeof(PositionStream4), index];
    }
    ...
    public static PositionStream4 From(VertexUnit unit) {
      return From(unit, 0);
    }
    ...
    public override IGraphicsStream Clone() {
      IGraphicsStream stream = new PositionStream4(this.Size);
      stream.Copy(this);
      return stream;
    }
    //---------------------------------------------------------------
