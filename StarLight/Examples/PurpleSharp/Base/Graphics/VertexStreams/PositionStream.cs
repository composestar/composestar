...
namespace Purple.Graphics.VertexStreams
{
	...
	/// </remarks>
	//=================================================================
	public class PositionStream : GraphicsStream, IVertexStream{
		//---------------------------------------------------------------
		#region Variables
		//---------------------------------------------------------------
    ...
    /// </summary>
    static protected VertexElement defaultElement = new VertexElement(0, 0, DeclarationType.Float3,
    ...
    static public void Bind() {
      StreamFactory.Instance.Bind(name, typeof(PositionStream), defaultElement);
    }
		...
		public PositionStream(VertexUnit vertexUnit) : base(vertexUnit.Size) {
      this.vertexUnit = vertexUnit;
		...
		public PositionStream(int size) : base(size) {
		}
    ...
    public static PositionStream From(VertexUnit unit, int index) {
      return (PositionStream)unit[typeof(PositionStream), index];
    }
    ...
    public static PositionStream From(VertexUnit unit) {
      return From(unit, 0);
    }
    ...
    public override IGraphicsStream Clone() {
      IGraphicsStream stream = new PositionStream(this.Size);
      stream.Copy(this);
      return stream;
    }

    /// <summary>
    /// Transforms the <see cref="PositionStream"/> by a given matrix.
    /// </summary>
    /// <param name="matrix">Matrix to use for transforming the <see cref="PositionStream"/>.</param>
    public void Transform( Matrix4 matrix) {
      for (int i=0; i<data.Length; i++)
        data[i] = data[i] * matrix;
    }
		//---------------------------------------------------------------
		#endregion
		//---------------------------------------------------------------
