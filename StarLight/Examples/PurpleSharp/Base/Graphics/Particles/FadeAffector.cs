...
namespace Purple.Graphics.Particles
{
  ...
  /// </remarks>
  //=================================================================
  public class FadeAffector : IParticleAffector {
    //---------------------------------------------------------------
    ...
    //---------------------------------------------------------------
    /// <summary>
    /// Creates a new instance of a <see cref="FadeAffector"/>.
    /// </summary>
    public FadeAffector() {
    }
    //---------------------------------------------------------------
    ...
    public void Affect(IList particles, int filled, float deltaTime) {
      for (int i=0; i<filled; i++) {
        ...
        (particle as IParticleColor).Alpha = System.Math.Max(0.0f, (particle as IParticleColor).Alpha - deltaTime/particle.LifeTime);
      }
    }
    //---------------------------------------------------------------
    #endregion
