...
namespace Purple.Graphics.Particles
{
  ...
  /// </remarks>
  //=================================================================
  public class Particle : ParticleBase, IParticle3d, IParticleColor, IParticleIndex  {
    //---------------------------------------------------------------
    ...
    /// </summary>
    public Particle() : this( Vector3.Zero, Vector3.Zero) {
    }
    ...
    private Particle(Particle particle) : base(particle) {
