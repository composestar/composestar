...
namespace DeviceController.Devices.DeviceA
{
    ...
    public class DeviceA
    {
        ...
        /// <summary>
        /// Execute commands on this device, tracing for this method is enabled by concern TraceDeviceA.
        /// </summary>
        ...
        /// <summary>
        /// Gets the result from the device after a call to DoSomething, tracing for this method is enabled by concern TraceDeviceA.
        /// </summary>
