	...
	public class RC6Engine : BlockCipher
	{
		...
		*/
		...
		public int processBlock(
			...
			int     outOff)
		{
			return (forEncryption) ? encryptBlock(inBytes, inOff, outBytes, outOff) 
		...
		*/
			...
			int     outOff)
		{
			...
			int A = bytesToWord(inBytes, inOff);
			int B = bytesToWord(inBytes, inOff + bytesPerWord);
			int C = bytesToWord(inBytes, inOff + bytesPerWord*2);
			int D = bytesToWord(inBytes, inOff + bytesPerWord*3);
