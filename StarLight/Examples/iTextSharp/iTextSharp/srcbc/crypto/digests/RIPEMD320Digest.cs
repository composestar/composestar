...
namespace org.bouncycastle.crypto.digests
{
	...
	public class RIPEMD320Digest:GeneralDigest
	{
        ...
        protected override void processWord(
            ...
            int inOff)
        {
            X[xOff++] = (inBytes[inOff] & 0xff) | ((inBytes[inOff + 1] & 0xff) << 8)
                | ((inBytes[inOff + 2] & 0xff) << 16) | ((inBytes[inOff + 3] & 0xff) << 24);
        ...
        public override int doFinal(byte[] outBytes, int outOff)
		{
			...
			unpackWord(H0, outBytes, outOff);
            unpackWord(H1, outBytes, outOff + 4);
            unpackWord(H2, outBytes, outOff + 8);
            unpackWord(H3, outBytes, outOff + 12);
            unpackWord(H4, outBytes, outOff + 16);
            unpackWord(H5, outBytes, outOff + 20);
            unpackWord(H6, outBytes, outOff + 24);
            unpackWord(H7, outBytes, outOff + 28);
            unpackWord(H8, outBytes, outOff + 32);
            unpackWord(H9, outBytes, outOff + 36);
