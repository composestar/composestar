...
namespace org.bouncycastle.crypto.digests
{
	...
	*/
	public class TigerDigest : Digest
	{
		/*
		* S-Boxes.
		*/
		...
		private static readonly int    DIGEST_LENGTH = 24;
		...
		*/
		public TigerDigest(TigerDigest t)
		{
			...
			Array.Copy(t.buf, 0, buf, 0, t.buf.Length);
			bOff = t.bOff;
		...
		public void unpackWord(
			...
			int     outOff)
		{
			outBytes[outOff + 7]     = (byte)(r >> 56);
			outBytes[outOff + 6] = (byte)(r >> 48);
			outBytes[outOff + 5] = (byte)(r >> 40);
			outBytes[outOff + 4] = (byte)(r >> 32);
			outBytes[outOff + 3] = (byte)(r >> 24);
			outBytes[outOff + 2] = (byte)(r >> 16);
			outBytes[outOff + 1] = (byte)(r >> 8);
			outBytes[outOff] = (byte)r;
		}
			...
			int     outOff)
		{
			...
			unpackWord(a, outBytes, outOff);
			unpackWord(b, outBytes, outOff + 8);
			unpackWord(c, outBytes, outOff + 16);
