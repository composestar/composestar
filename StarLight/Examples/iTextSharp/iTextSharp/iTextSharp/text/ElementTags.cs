...
namespace iTextSharp.text 
{
    ...
    public class ElementTags 
    {
        ...
        /// <summary> attribute of the chunk tag </summary>
        public static readonly string SUBSUPSCRIPT = Chunk.SUBSUPSCRIPT.ToLower();
    
        /// <summary> attribute of the chunk tag </summary>
        public static readonly string LOCALGOTO = Chunk.LOCALGOTO.ToLower();
    
        /// <summary> attribute of the chunk tag </summary>
        public static readonly string REMOTEGOTO = Chunk.REMOTEGOTO.ToLower();
    
        /// <summary> attribute of the chunk tag </summary>
        public static readonly string LOCALDESTINATION = Chunk.LOCALDESTINATION.ToLower();
    
        /// <summary> attribute of the chunk tag </summary>
        public static readonly string GENERICTAG = Chunk.GENERICTAG.ToLower();
