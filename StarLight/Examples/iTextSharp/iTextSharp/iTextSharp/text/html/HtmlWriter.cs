    ...
    public class HtmlWriter : DocWriter ,IDocListener {
        ...
        protected void Write(IElement element, int indent) {
            ...
            switch (element.Type) {
                ...
                case Element.PHRASE: {
                    ...
                    styleAttributes = new Properties();
                    if (phrase.LeadingDefined) styleAttributes[MarkupTags.CSS_KEY_LINEHEIGHT] = phrase.Leading.ToString() + "pt";
                ...
                case Element.ANCHOR: {
                    ...
                    styleAttributes = new Properties();
                    if (anchor.LeadingDefined) styleAttributes[MarkupTags.CSS_KEY_LINEHEIGHT] = anchor.Leading.ToString() + "pt";
                ...
                case Element.PARAGRAPH: {
                    ...
                    styleAttributes = new Properties();
                    if (paragraph.LeadingDefined) styleAttributes[MarkupTags.CSS_KEY_LINEHEIGHT] = paragraph.Leading.ToString() + "pt";
                ...
                case Element.LISTITEM: {
                    ...
                    styleAttributes = new Properties();
                    if (listItem.LeadingDefined) styleAttributes[MarkupTags.CSS_KEY_LINEHEIGHT] = listItem.Leading.ToString() + "pt";
        ...
        protected void WriteSection(Section section, int indent) {
            if (section.Title != null) {
                ...
                if (section.Title.LeadingDefined) styleAttributes[MarkupTags.CSS_KEY_LINEHEIGHT] = section.Title.Leading.ToString() + "pt";
                // start tag
                AddTabs(indent);
        ...
        protected void Write(Font font, Properties styleAttributes) {
            ...
            if (IsOtherFont(font)) {
                WriteCssProperty(MarkupTags.CSS_KEY_FONTFAMILY, font.Familyname);
            
                if (font.Size != Font.UNDEFINED) {
                    WriteCssProperty(MarkupTags.CSS_KEY_FONTSIZE, font.Size.ToString() + "pt");
                }
                if (font.Color != null) {
