...
/*
 * $Id: RtfListTable.cs,v 1.1 2005/07/04 22:51:36 psoares33 Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.rtf.list {
    ...
    */
    public class RtfListTable : RtfElement, IRtfExtendedElement {
        ...
        */
        private static byte[] LIST_HYBRID = DocWriter.GetISOBytes("\\hybrid");
        /**
        ...
        public byte[] WriteDefinition() {
            ...
            try {
                ...
                for (int i = 0; i < lists.Count; i++) {
                    ...
                    result.WriteByte((byte)'\n');
                    result.Write(t = ((RtfList) lists[i]).WriteDefinition(), 0, t.Length);
