        ...
        public byte[] Write() {
            ...
            try {
                if (this.mode == MODE_SINGLE) {
                    result.Write(t = headerAll.Write(), 0, t.Length);
                } else if (this.mode == MODE_MULTIPLE) {
                    if (headerFirst != null) {
                        result.Write(t = headerFirst.Write(), 0, t.Length);
                    }
                    if (headerLeft != null) {
                        result.Write(t = headerLeft.Write(), 0, t.Length);
                    }
                    if (headerRight != null) {
                        result.Write(t = headerRight.Write(), 0, t.Length);
                    }
                    if (headerAll != null) {
                        result.Write(t = headerAll.Write(), 0, t.Length);
                    }
