...
namespace iTextSharp.text.pdf {
    ...
    */
    public class PdfReader {
        ...
        static PdfName[] vpnames = {PdfName.HIDETOOLBAR, PdfName.HIDEMENUBAR,
            PdfName.HIDEWINDOWUI, PdfName.FITWINDOW, PdfName.CENTERWINDOW, PdfName.DISPLAYDOCTITLE};
        static int[] vpints = {PdfWriter.HideToolbar, PdfWriter.HideMenubar,
...
//                name = ((PdfName)PdfReader.GetPdfObjectRelease((PdfObject)filters[j])).ToString();
...
//        }
        ...
        protected internal void RemoveUnusedNode(PdfObject obj, bool[] hits) {
            ...
            switch (obj.Type) {
                ...
                case PdfObject.INDIRECT: {
                    ...
                    if (!hits[num]) {
                        hits[num] = true;
                        RemoveUnusedNode(GetPdfObjectRelease(refi), hits);
                    }
                    break;
                }
            }
        ...
        */
        public int ViewerPreferences {
            ...
            set {
                SetViewerPreferences(value, catalog);
            }
        }
