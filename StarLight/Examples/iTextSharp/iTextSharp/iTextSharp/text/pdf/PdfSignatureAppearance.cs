...
namespace iTextSharp.text.pdf {
    ...
    */
    public class PdfSignatureAppearance {
        ...
        */    
        public void SetCrypto(CipherParameters privKey, X509Certificate[] certChain, object[] crlList, PdfName filter) {
        ...
        */    
        public CipherParameters PrivKey {
            get {
                return privKey;
            }
        }
        ...
        public void PreClose(Hashtable exclusionSizes) {
            ...
            if (fieldExists && name.IndexOf('.') >= 0) {
                ...
                if (fieldExists) {
                    ...
                    PdfObject obj = PdfReader.GetPdfObjectRelease(((PdfDictionary)merged[0]).Get(PdfName.F));
        ...
        */    
        ...
        private static int IndexFile(FileStream raf, int position, String search) {
            byte[] ss = PdfEncodings.ConvertToBytes(search, null);
            while (true) {
