...
namespace iTextSharp.text.pdf {
    ...
    public class BarcodeEAN : Barcode {
        ...
        internal const int TOTALBARS_EAN13 = 11 + 12 * 4;
        /** The total number of bars for EAN8.*/
        internal const int TOTALBARS_EAN8 = 11 + 8 * 4;
        /** The total number of bars for UPCE.*/
        internal const int TOTALBARS_UPCE = 9 + 6 * 4;
        /** The total number of bars for supplemental 2.*/
        internal const int TOTALBARS_SUPP2 = 13;
        /** The total number of bars for supplemental 5.*/
        internal const int TOTALBARS_SUPP5 = 31;
        /** Marker for odd parity.*/
        internal const byte ODD = 0;
        /** Marker for even parity.*/
        internal const byte EVEN = 1;
