...
namespace iTextSharp.text.pdf {
    ...
    */
    public class SimpleBookmark : ISimpleXMLDocHandler {
        ...
        */
        public static void ExportToXMLNode(ArrayList list, StreamWriter outp, int indent, bool onlyASCII) {
            String dep = "";
            ...
            foreach (Hashtable map in list) {
                ...
                foreach (String key in map.Keys) {
                    if (key.Equals("Title")) {
                        title = (String)map[key];
                        continue;
                    }
                    else if (key.Equals("Kids")) {
                        kids = (ArrayList)map[key];
                        continue;
                    }
                    else {
                        outp.Write(key);
        ...
        * @throws IOException on error
        */
        public static void ExportToXML(ArrayList list, StreamWriter wrt, String encoding, bool onlyASCII) {
