    ...
    private String[] GetListOption(String fieldName, int idx) {
        ...
        */    
        ...
        internal PdfAppearance GetAppearance(PdfDictionary merged, String text, String fieldName) {
            ...
            if (fieldCache == null || !fieldCache.ContainsKey(fieldName)) {
                ...
                if (nfl != null)
                    flags = nfl.IntValue;
                tx.Options = ((flags & PdfFormField.FF_MULTILINE) == 0 ? 0 : TextField.MULTILINE) | ((flags & PdfFormField.FF_COMB) == 0 ? 0 : TextField.COMB);
        ...
        internal Color GetMKColor(PdfArray ar) {
            ...
            switch (cc.Count) {
                ...
                case 3:
                    return new Color(((PdfNumber)cc[0]).FloatValue, ((PdfNumber)cc[1]).FloatValue, ((PdfNumber)cc[2]).FloatValue);
                case 4:
        ...
        */    
        public PdfPKCS7 VerifySignature(String name) {
            ...
            if (str != null)
                pk.SignName = str.ToUnicodeString();
