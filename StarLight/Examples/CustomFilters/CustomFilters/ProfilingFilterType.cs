...
[assembly: ConflictRule("frequency", "((write)(write)+)?(read)", true, "Resulting value is invalid")]
[assembly: ConflictRule("starttime", "((write)(write)+)?(read)", true, "Resulting value is invalid")]
