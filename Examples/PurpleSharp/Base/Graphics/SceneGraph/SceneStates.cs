...
namespace Purple.Graphics.SceneGraph {
  //=================================================================
  /// <summary>
  /// Collection of scene state objects
  ...
  public class SceneStates : IEnumerable, ICollection {
    //---------------------------------------------------------------
    #region Variables
    //---------------------------------------------------------------
    SceneState[] array = null;
    int filled = 0;
    //---------------------------------------------------------------
    #endregion
    //---------------------------------------------------------------
    ...
    /// </summary>
    public SceneState this[int index] {
      get {
    ...
    /// <summary>
    /// appens a new SceneState and returns it
    /// </summary>
    public SceneState Next {
      get {
        if (array == null || array.Length <= filled)
          Add(SceneState.Default);
        filled++;
        return array[filled-1];
      }
    }
    ...
    //---------------------------------------------------------------
    /// <summary>
    /// creates an instance of an leaf entities object
    /// </summary>
    public SceneStates() {
    }
    //---------------------------------------------------------------
    ...
    public void Add(SceneState element) {
      if (array == null)
        array = new SceneState[2];
    ...
    public void Resize(int size) {
      ...
      SceneState[] newArray = new SceneState[size];
