...
namespace Purple.Graphics.VertexStreams {
  ...
  /// </remarks>
  //=================================================================
  public class BoneWeightsStream : GraphicsStream, IVertexStream, IBoneWeightsStream{
    //---------------------------------------------------------------
    #region Variables
    //---------------------------------------------------------------
    static string name = "BoneWeightsStream";
    /// <summary>
    /// The default element for BoneWeightsStreams.
    /// </summary>
    static protected VertexElement defaultElement = new VertexElement(0, 0, DeclarationType.Float4,
      DeclarationMethod.Default,
      DeclarationUsage.BoneWeights, 0);
    ...
    static float[] getArray = new float[4];
    //---------------------------------------------------------------
    #endregion
    //---------------------------------------------------------------
    ...
    static public void Bind() {
      StreamFactory.Instance.Bind(name, typeof(BoneWeightsStream), defaultElement);
    }
    ...
    public BoneWeightsStream(VertexUnit vertexUnit) : base(vertexUnit.Size) {
    ...
    public BoneWeightsStream(int size) : base(size) {
    }
    ...
    public void SetWeight(int vertexIndex, int weightIndex, float weight) {
      data[vertexIndex][weightIndex] = weight;
    }
    ...
    public float GetWeight(int vertexIndex, int weightIndex) {
      return data[vertexIndex][weightIndex];
    }
    ...
    public void SetWeights(int vertexIndex, float[] weights) {
      ...
      int count = System.Math.Min(4, weights.Length);
      for (int i=0; i<count; i++)
        vec[i] = weights[i];
      data[vertexIndex] = vec;
    }
    ...
    public override IGraphicsStream Clone() {
      IGraphicsStream stream = new BoneWeightsStream(this.Size);
      stream.Copy(this);
      return stream;
    }
    //---------------------------------------------------------------
