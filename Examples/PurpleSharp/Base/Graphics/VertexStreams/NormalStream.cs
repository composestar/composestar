...
namespace Purple.Graphics.VertexStreams
{
	...
	/// </remarks>
	//=================================================================
	public class NormalStream : PositionStream {
		//---------------------------------------------------------------
		#region Variables
		//---------------------------------------------------------------
    ...
    static public new void Bind() {
      ...
      StreamFactory.Instance.Bind(name, typeof(NormalStream), element);
    }
		...
		public NormalStream(VertexUnit vertexUnit) : base(vertexUnit) {
      Usage = DeclarationUsage.Normal;
		...
		public NormalStream(int size) : base(size) {
      Usage = DeclarationUsage.Normal;
		}
