...
namespace Purple.Graphics.Lighting {
  ...
  public class SpotLight : Light {
    ...
    public float CosAlpha {
      get {
        return Math.Trigonometry.Cos(alpha);
      }
    }
    ...
    public override void Bind(IShaderConstant constant) {
      ...
      if (constant.Children.Contains("Direction"))
        constant.Children["Direction"].UpdateHandler += new UpdateHandler( UpdateObjectSpaceDirection );
      if (constant.Children.Contains("CosAlpha"))
        constant.Children["CosAlpha"].Set( CosAlpha );
    }
