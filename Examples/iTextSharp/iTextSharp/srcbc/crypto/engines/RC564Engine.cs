	...
	public class RC564Engine : BlockCipher
	{
		...
		*/
		private int encryptBlock(
			...
			int     outOff)
		{
			long A = bytesToWord(inBytes, inOff) + _S[0];
			long B = bytesToWord(inBytes, inOff + bytesPerWord) + _S[1];
		...
		private int decryptBlock(
			...
			int     outOff)
		{
			long A = bytesToWord(inBytes, inOff);
			long B = bytesToWord(inBytes, inOff + bytesPerWord);
