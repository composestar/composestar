...
namespace iTextSharp.text.rtf.direct {
    ...
    */
    public class RtfTokeniser {
        ...
        */
        private const int TOKENISER_STATE_READY = 0;
        /**
        * The last token parsed was a slash.
        */
        private const int TOKENISER_STATE_SLASH = 1;
        /**
        * The RtfTokeniser is currently tokenising a control word.
        */
        private const int TOKENISER_STATE_IN_CTRL_WORD = 2;
        /**
        * The RtfTokeniser is currently tokenising a text.
        */
        private const int TOKENISER_STATE_IN_TEXT = 4;
        ...
        */
        public void Tokenise(TextReader reader) {
            char[] nextChar = new char[1];
            String temp = "";
            this.state = TOKENISER_STATE_READY;
            this.groupLevel = 0;
            while (reader.Read(nextChar, 0, nextChar.Length) != -1) {
