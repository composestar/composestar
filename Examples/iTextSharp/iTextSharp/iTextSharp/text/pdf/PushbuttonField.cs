    ...
    public class PushbuttonField : BaseField {
        ...
        */    
        public PdfAppearance GetAppearance() {
            ...
            if (tp != null) {
                float icx = iconBox.Width / tp.BoundingBox.Width;
                float icy = iconBox.Height / tp.BoundingBox.Height;
                if (proportionalIcon) {
                    switch (scaleIcon) {
                ...
                float xpos = iconBox.Left + (iconBox.Width - (tp.BoundingBox.Width * icx)) * iconHorizontalAdjustment;
                float ypos = iconBox.Bottom + (iconBox.Height - (tp.BoundingBox.Height * icy)) * iconVerticalAdjustment;
                app.SaveState();
