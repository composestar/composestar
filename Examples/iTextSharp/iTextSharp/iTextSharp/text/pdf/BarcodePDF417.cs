    ...
    */
    public class BarcodePDF417 {
        ...
        */
        ...
        protected const int MACRO_SEGMENT_COUNT=923;
        protected const int MACRO_LAST_SEGMENT=922;

        const string MIXED_SET = "0123456789&\r\t,:#-.$/+%*=^";
        const string PUNCTUATION_SET = ";<>@[\\]_`~!\r\t,:\n-.$/\"|*()?{}'";

        static int[][] CLUSTERS = new int[][]
        {new int[]{
        ...
        static int[][] ERROR_LEVEL = new int[][]
        {new int[]{
            27, 917
        }, new int[]{
            522, 568, 723, 809
