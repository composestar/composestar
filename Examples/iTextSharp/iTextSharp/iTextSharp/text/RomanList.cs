    ...
    public class RomanList : List {
        ...
        */
        public override bool Add(Object o) {
            if (o is ListItem) {
                ...
                Chunk chunk;
                if (romanlower)
                    chunk = new Chunk(ToRomanLowerCase(first + list.Count), symbol.Font);
                else
                    chunk = new Chunk(ToRomanUppercase(first + list.Count), symbol.Font);
                chunk.Append(".");
        ...
        */
        public static string ToRomanUppercase(int number) {
            return ToRomanLowerCase(number).ToUpper();
        }
        ...
        */
        private class RomanDigit {
            ...
            */
            public RomanDigit(char digit, int value, bool pre) {
                this.digit = digit;
                this.value = value;
                this.pre = pre;
            }
