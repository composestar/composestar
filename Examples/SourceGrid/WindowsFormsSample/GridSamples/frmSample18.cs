...
namespace WindowsFormsSample
{
	...
	public class frmSample18 : System.Windows.Forms.Form
	{
		...
		{
			DateTime l_ToDayPlus3 = DateTime.Today.AddDays(3);
			DateTime l_ToDayMinus3 = DateTime.Today.AddDays(-3);
			DateTime l_Now = DateTime.Now;


			cbStart.Validator = new DevAge.ComponentModel.Validator.ValidatorTypeConverter(typeof(DateTime));
			cbStart.Value = new DateTime(l_ToDayMinus3.Year, l_ToDayMinus3.Month, l_ToDayMinus3.Day, 8, 0, 0);
			cbEnd.Validator = new DevAge.ComponentModel.Validator.ValidatorTypeConverter(typeof(DateTime));
			cbEnd.Value = new DateTime(l_ToDayPlus3.Year, l_ToDayPlus3.Month, l_ToDayPlus3.Day, 18, 0, 0);

			listEditor1.ItemType = typeof(SourceGrid.Planning.AppointmentBase);

			planningGrid1.Appointments.Add( new SourceGrid.Planning.AppointmentBase("Dentist", new DateTime(l_Now.Year, l_Now.Month, l_Now.Day, 9, 0,0) , new DateTime(l_Now.Year, l_Now.Month, l_Now.Day, 11, 30,0) ) );
			planningGrid1.Appointments.Add( new SourceGrid.Planning.AppointmentBase("Appointment 1", new DateTime(l_Now.Year, l_Now.Month, l_Now.Day, 16, 0,0) , new DateTime(l_Now.Year, l_Now.Month, l_Now.Day, 16, 45,0) ) );
