...
namespace WindowsFormsSample
{
	...
	/// </summary>
	[Sample("SourceGrid - Extensions", 9, "Data Binding - DataGrid")]
	public class frmSample9 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.lbRowsNumber.Location = new System.Drawing.Point(332, 124);
			...
			this.chkAllowNew.Size = new System.Drawing.Size(100, 24);
		...
		{
			foreach (SourceGrid.DataGridColumn column in dataGrid.Columns)
			{
				if (column.DataCell != null && column.DataCell.Editor != null)
					column.DataCell.Editor.EnableEdit = chkEdit.Checked;
			}
		}
//
...
//				dataGrid.EnableDelete = true;
//			else
//				dataGrid.EnableDelete = false;
//		}
//
...
//				l_dg.DataTable = dataGrid.DataTable;
//				if (l_dg.ShowDialog(this) == DialogResult.OK)
//				{
//					m_TemplateColumns = l_dg.TemplateColumns;
//					dataGrid.LoadDataSource(dataGrid.DataTable, dataGrid.GridStyle, m_TemplateColumns);
//				}
//			}
//		}
//
