...
namespace SourceGrid
{
	...
	public struct CellContext
	{
		...
		public System.Drawing.Size Measure(System.Drawing.Size maxLayoutArea)
		{
			...
			requiredSize.Width = requiredSize.Width / range.ColumnsCount;
			requiredSize.Height = requiredSize.Height / range.RowsCount;
		...
		public void StartEdit()
		{
			...
			if (Cell.Editor != null && 
				...
				Grid.Selection.Focus(Position)) //per finire eventuali altri edit e posizionare il focus su questa cella
			{
		...
		/// <summary>
		/// The string representation of the Model.ValueModel.GetValue method (default ToString())
		/// </summary>
		/// <returns></returns>
