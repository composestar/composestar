...
namespace SourceGrid.Cells.Controllers
{
	...
	public class CustomEvents : IController
	{
		...
		public event RangeRegionChangingEventHandler SelectionAdding;
		public virtual void OnSelectionAdding(CellContext sender, RangeRegionChangingEventArgs e)
		{
			if (SelectionAdding!=null)
				SelectionAdding(sender, e);
		}
		public event RangeRegionChangingEventHandler SelectionRemoving;
		public virtual void OnSelectionRemoving(CellContext sender, RangeRegionChangingEventArgs e)
		{
			if (SelectionRemoving!=null)
				SelectionRemoving(sender, e);
		}
		public event RangeRegionEventHandler SelectionAdded;
		public virtual void OnSelectionAdded(CellContext sender, RangeRegionEventArgs e)
		{
			if (SelectionAdded!=null)
				SelectionAdded(sender, e);
		}
		public event RangeRegionEventHandler SelectionRemoved;
		public virtual void OnSelectionRemoved(CellContext sender, RangeRegionEventArgs e)
		{
			if (SelectionRemoved!=null)
				SelectionRemoved(sender, e);
		}
