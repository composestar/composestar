 ...
 * ErrorAction.java 2072 2006-10-15 12:44:56Z elmuerte $ Models the action that
 * is produced when a message is rejected by an Error Filter The action defined
 * is the throw of a ErrorFilterException.
 */
public class ErrorAction extends ComposeStarAction
{
	...
	/**
	 * Constructs an error action The error action takes the exception to be
	 * thrown, and throws it when it's executed.
	 * 
