 ...
 * InvalidConditionException.java 2032 2006-10-12 15:08:13Z reddog33hummer $
 * Exception that deals with calls to invalid conditions (that is, conditions
 * that are not defined in the enclosing FilterModule). Contains information
 * about the condition resolver used.
 */
public class InvalidConditionException extends FilterSpecificationException
{
	...
	/**
	 * Constructs a new Invalid Condition Exception along with the accompanying
	 * message
	 * 
