...
/**
 * General Exception class for Composestar Runtime. J# does not support nested
 * exceptions on type throwable. To keep Composestar.RuntimeCore buildable by
 * both J# and Java, we introduce nested exceptions as implemented by Java 1.4.
 * This means DotNET applications should use getCause() and not property
 * InnerException.
 */
public class ComposestarRuntimeException extends RuntimeException
{
	 ...
	 * cause. This may only be set once; so the field is set to this until
	 * initialized.
	 * 
