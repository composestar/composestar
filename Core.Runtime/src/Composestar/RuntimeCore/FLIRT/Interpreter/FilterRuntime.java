 ...
 * FilterRuntime.java 2072 2006-10-15 12:44:56Z elmuerte $
 */
public class FilterRuntime extends ReferenceEntityRuntime implements Interpretable
{
	 ...
	 */
	public ComposeStarAction getAcceptAction(MessageList originalMessage, MessageList modifiedMessage,
			Dictionary context)
	{
	 ...
	 * @param modifiedMessage
	 */
	public ComposeStarAction getRejectAction(MessageList originalMessage, MessageList modifiedMessage,
			Dictionary context)
	{
