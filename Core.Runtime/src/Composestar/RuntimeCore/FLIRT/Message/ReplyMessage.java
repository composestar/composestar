 ...
 * ReplyMessage.java 1518 2006-09-20 13:13:30Z reddog33hummer $ Models the
 * reified message that is handed over to the ACTcallbacks It allows for the
 * replacement of the return value of the message
 */
public class ReplyMessage extends ReifiedMessage
{
	...
	/**
	 * Replaces the return value with a new one. No checks are done to see if
	 * the new return value fills the interface requirements of the message
	 * (that is, if it is a valid type)
	 * 
