...
public class FLIRT
{
	 ...
	 * Debug.out(Debug.MODE_INFORMATION,"FLIRT","Starting..."); CommonResources
	 * cr = new CommonResources(); FLIRT flirt = new FLIRT();
	 * MessageHandlingFacility.handleApplicationStart("repository.xml");
	 * Object[] arguments = {new String("Hello World")}; flirt.run(cr);
