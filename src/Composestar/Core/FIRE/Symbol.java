 ...
 * 
 * $Id: Symbol.java,v 1.2 2006/02/13 11:53:08 pascal Exp $
 * 
**/
...
public class Symbol
{
	...
	public String toString()
	{
		...
		switch (type)
		{
			case 0: typeStr = "condition"; break;
			case 1: typeStr = "target"; break;
			case 2: typeStr = "selector"; break;
            default:typeStr = "unknown"; break;
		}

		if (Debug.getMode() > Debug.MODE_WARNING) return "Symbol: " + name + " " + typeStr + (column != null ? column.toString() : "");
		else return name;
	}
	...
	{
		signatures.put(selector, new Boolean(true));
	}

	public void addNotSignature (Symbol selector)
	{
		signatures.put(selector, new Boolean(false));
	}
