...
public class DefaultEmitter implements DummyEmitter
{
	...
	{
	/*
	 * For languages where no emitter is used, this is the default. Also use
	 * this when dummies are already generated somewhere else (e.g. in the
	 * visual studio addin)
	 */
	}

	/*
	 * Classes extending this default behaviour can override it to obtain more
	 * efficient behaviour (e.g. handle generation of multiple dummies in 1 go
	 * instead of calling createDummy for each of them)
	 */
