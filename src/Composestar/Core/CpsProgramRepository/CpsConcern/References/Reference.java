 ...
 *
 * $Id: Reference.java,v 1.2 2006/02/16 12:51:21 composer Exp $
 */
 ...
 * searching the repository, but it can also be a pseudo variable (server, sender,
 * inner, message, ...); in this case, it may, or may not be possible to resolve
 * the name (i.e. to let it refer to a concern that defines its signature)
 */
