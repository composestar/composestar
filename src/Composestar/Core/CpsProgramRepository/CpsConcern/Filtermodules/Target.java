 ...
 *
 * $Id: Target.java,v 1.2 2006/02/16 12:51:21 composer Exp $
 */
...
/**
 * should be either a declared (in the scope) object or a pseudo variable (inner)
 * or a wildcard;
 * [if it was only a reference, it would be a ConcernReference, perhaps it could
 * inherit from ConcernReference??? ]
 */
public class Target extends ContextRepositoryEntity {
    
    /**
     * fixme: same information twice, name kept for compatibility, should only be ref
     */
    public String name;
    ...
    /**
     * @return 
     * Composestar.Core.CpsProgramRepository.CpsConcern.References.FilterModuleElem
     * entReference
