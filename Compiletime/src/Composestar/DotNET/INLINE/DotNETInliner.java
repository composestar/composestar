...
import Composestar.Core.INLINE.lowlevel.LowLevelInliner;
import Composestar.Core.LAMA.MethodInfo;
import Composestar.Core.LAMA.Type;
import Composestar.Core.Master.CommonResources;
import Composestar.Core.RepositoryImplementation.DataStore;
import Composestar.DotNET.INLINE.DotNETInlineStrategy.Block;
import Composestar.DotNET.INLINE.DotNETInlineStrategy.ContextAction;

public class DotNETInliner{
    private LowLevelInliner inliner;
    private DotNETInlineStrategy inlineStrategy;
    ...
    public DotNETInliner(){
	this.inlineStrategy = new DotNETInlineStrategy( this );
	this.inliner = new LowLevelInliner( inlineStrategy );
    }
	...
	methodStructure.inputFilterCode = inlineStrategy.getInlineBlock();
	...
	callBlock.outputFilterCode = inlineStrategy.getInlineBlock();
    ...
    protected void addInnerCallCheckTask( ContextAction innerCallAction )
    {
