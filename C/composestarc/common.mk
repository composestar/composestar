...
CLASSPATH=.$(SEP)../$(ROOTDIR)composestarcore/src$(SEP)$(ROOTDIR)binaries/junit/junit.jar$(SEP)$(ROOTDIR)binaries/prolog/prolog.jar$(SEP)$(ROOTDIR)binaries/antlr/antlr.jar
