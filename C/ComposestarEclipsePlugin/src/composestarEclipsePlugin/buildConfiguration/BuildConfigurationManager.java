...
private static BuildConfigurationManager Instance = null;
	...
	public void saveToXML(String fileName) {
		try {
			...
			//projects
			bw.write(spacePad(1)+"<Projects applicationStart=\""+applicationStart+"\" runDebugLevel=\""+runDebugLevel+"\" outputPath=\""+outputPath+"\">\n");
			...
			//settings
			bw.write(spacePad(1)+"<Settings composestarIni=\"C:/local/Johan/ComposeStar/Composestar.ini\" buildDebugLevel=\""+buildDebugLevel+"\" compilePhase=\"one\" platform=\"c\">\n");
			...
			bw.write( spacePad(3)+ "<Path name=\"NETSDK\" pathName=\"C:/Program Files/Microsoft Visual Studio .NET 2003/SDK/v1.1/Bin/\" />\n");
