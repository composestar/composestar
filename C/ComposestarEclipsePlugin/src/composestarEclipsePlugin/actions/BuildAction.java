...
/**
 * This action should call the BuildConfigurationManager, 
 * furthermore a property page should be opened (to select main class of selected project)
 * finally the compose* compiler should be called (call to Master)
 * TODO: add timer to time the building proces.
 * TODO: support for building multiple projects.
 */
...
public class BuildAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		if(dialog.getReturnCode()==dialog.OK){
			...
			composestarPath.setPath(eclipseInstallationOS+"plugins"+java.io.File.separatorChar+"ComposestarEclipsePlugin"+java.io.File.separatorChar);
