 ...
 *
 * $Id: CRepositorySerializer.java,v 1.1 2006/09/01 15:31:20 johantewinkel Exp $
 */
 ...
 * repository. Therefor, certain elements can be kept out of the dump by
 * switching their accessiblility to private/protected.
 * 
 * @author Tom Staijen
 * @version 0.9.0
 */
public class CRepositorySerializer implements RepositorySerializer
{
	...
	private void write(DataStore obj) throws ModuleException
	{
		...
		Enumeration keys = obj.map.m_keys.elements();// updated 31-10 map.key
