...
public abstract class Semantic {
	...
	protected String conditionCode(){
		...
		if(fil.filterElementAST.conditionPart instanceof ConditionVariable){//ConditionExpression){
	...
	protected String substitutionFunction(){
		return ((SubstitutionPart)(filter.getFilterElement(elementNumber).getMatchingPattern().getSubstitutionParts().elementAt(0))).getSelector().getName();
	}
