...
public class Annotation {
	...
	private String type="";   
	private String target =""; //type, method, field -> the original program element names
	...
	public void retrieveTarget(TNode annotationNode){
		...
		//System.out.println("Target of annotation is:"+target );//.getParent().getText());
	}
	
	public void printAnnotation(){
		Debug.out(Debug.MODE_INFORMATION,"ANNOTATION","Annotation:"+ type+ "\n" + "Value first element:"+ (String)values.get(0)+ "\n" + "Target:" + target+"\n");
	}
	...
	public void addAnnotationtoLAMA(){
		Composestar.Core.LAMA.Annotation annot = new CAnnotation();
 		Concern c = null; 
 		if(type.equals("file")){
 			//Debug.out(Debug.MODE_ERROR, "Annotation Extractor", "Annotations type "+ filename +" is not declared");
