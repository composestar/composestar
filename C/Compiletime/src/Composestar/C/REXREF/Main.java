          ...
          else if(!modules.isEmpty())
          {
          	...
          	while(modIter.hasNext())
          	{
          		...
          		if(ref.getName().equals(module))
          		{
                    ...
                    ref.setResolved(true);
          			inCConcern =true;
          			Debug.out(Debug.MODE_INFORMATION,"REXREF","Found "+module+ " in cps concern as well as in xml file");
          		}
          	}
          	if(inCConcern == false) throw new ModuleException("ConcernReference '" + ref.getQualifiedName() + "' cannot be resolved (are you referencing a non-existent concern or is the startup object incorrect?)", "REXREF", ref);
          }
          else {
