...
public class Message{
    ...
    public boolean isGeneralization(){
        return checkEquals( selector, Message.STAR_SELECTOR )  ||  
        	checkEquals( target, Message.STAR_TARGET );
    }
    ...
    public boolean equals(Object obj) {
        ...
        return checkEquals( m.selector, selector )  &&  
        checkEquals( m.target, target );
    }
    ...
    public static boolean checkEquals( Target target1, 
            Target target2 )
    {
