...
public class CtlChecker {
    ...
    private boolean isSatisfied( ExecutionState state, CtlFormula formula, 
            Boolean reversed )
    {
        HashSet satSet;
    ...
    private class Checker implements CtlFormulaVisitor{
        ...
        public Object visitEG(EG formula, Object arg) {
            ...
            while( enumer.hasMoreElements() ){
                ...
                //(due to backward traversal this state is already checked):
                    ...
                    //state satisfies the formula (it is already checked whether 
                    ...
                    while( nextStates.hasMoreElements() ){
                        ExecutionState nextState = 
                            (ExecutionState) nextStates.nextElement();
        ...
        private void addSatisfy( ExecutionState state, CtlFormula formula, 
                Boolean reversed )
        {
            HashSet satSet;
    ...
    private class TreeCreator implements CtlFormulaVisitor{
        ...
        public Object visitAF(AF formula, Object arg) {
            ...
            DefaultMutableTreeNode child1 = 
                (DefaultMutableTreeNode) formula.subFormula.visit( this, null );
            node.add( child1 );
        ...
        public Object visitAnd(And formula, Object arg) {
            ...
            DefaultMutableTreeNode child1 = 
                (DefaultMutableTreeNode) formula.subFormula1.visit( this, null );
            node.add( child1 );

            DefaultMutableTreeNode child2 = 
                (DefaultMutableTreeNode) formula.subFormula2.visit( this, null );
            node.add( child2 );
