...
public class CtlParser {
    ...
    public static CtlFormula parse( String pattern, Dictionary predicates )
    throws CtlParseException
    {
    ...
    private static class Parser{
        ...
        public CtlFormula parse( String pattern )
        throws CtlParseException
        {
            return parseLevel1( new Lexer(pattern) );
        }
        
        private CtlFormula parseLevel1( Lexer lexer )
        throws CtlParseException
        {
        ...
        private CtlFormula parseLevel2( Lexer lexer )
        throws CtlParseException
        {
        ...
        private CtlFormula parseLevel3( Lexer lexer )
        throws CtlParseException
        {
        ...
        private CtlFormula parseLevel4( Lexer lexer )
        throws CtlParseException
        {
            CtlFormula formula1;
            CtlFormula formula2;
        ...
        private CtlFormula parseLevel5( Lexer lexer )
        throws CtlParseException
        {
            Token token = lexer.peekNextToken();
            switch( token.getType() ){
    ...
    private static class Lexer{
        ...
        throws CtlParseException
        {
            ...
            if ( Character.isLetter( c )  &&  Character.isLowerCase( c ) ){
                ...
                return new Token( Token.IDENTIFIER, buffer.toString(), pos,
                        buffer.length() );
            }
            else{
                throw new CtlParseException();
