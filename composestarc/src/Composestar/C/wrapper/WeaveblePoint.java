...
public class WeaveblePoint
{
	...
	public ArrayList prioritizeWeavingInstructions()
	{
		...
		for(int i=0; i < backup.size(); i++)
		{
			...
			//System.out.println("advice["+advice.getId()+"]: \t\t"+advice.getPriority()+" <= ");
			...
			for(int j=0; j < tmp; j++)
			{
				...
				//System.out.print("\tadvice["+adv.getId()+"]: \t"+adv.getPriority());
				//System.out.println(" == "+(advice.getPriority()<=adv.getPriority()));
