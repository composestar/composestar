...
import ComposestarEclipsePlugin.Core.BuildConfigGenerator;
...
public class JavaBuildConfigGenerator extends BuildConfigGenerator
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ComposestarEclipsePlugin.Core.BuildConfigGenerator#addProject(org.eclipse.core.resources.IProject)
	 */
	@Override
