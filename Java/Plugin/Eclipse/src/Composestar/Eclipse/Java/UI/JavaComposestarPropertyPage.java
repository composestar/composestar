...
public class JavaComposestarPropertyPage extends ComposestarPropertyPage implements IRunnableContext
{
	...
	private Composite createFirstSection(Composite controls)
	{
		...
		// fSearchExternalJarsCheckButton = createCheckButton(group,
	...
	{
		Composite group = new Composite(controls, SWT.FILL);
	...
	// }
	// searchScope = SearchEngine.createJavaSearchScope(new IJavaElement[] {
	// javaProject }, constraints);
	// }
	//
	...
	// try
	// {
	// types = engine.searchMainMethods(this, searchScope,
	...
	// try
	// {
	// dialog = JavaUI.createTypeDialog(getShell(), this,
