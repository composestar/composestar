 ...
 * @version $Id: Game.java 2663 2006-11-12 22:24:53Z elmuerte $
 */
package PacmanTwo;
...
public class Game implements Runnable {
	...
	/**
	 * Add a new game elements. These are also added to the tick list.
	 */
	...
	/**
	 * Return all registered game elements. Used by the viewport to get the
	 * elements to render
	 */
	...
	protected void tick(float delta) {
		for (int i = deadList.size() - 1; i >= 0; i--) {
			...
			if (tickList.remove(o)) { // gameElements are always in the
				// ticklist
