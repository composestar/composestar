 ...
 * @version $Id: PacmanView.java 2663 2006-11-12 22:24:53Z elmuerte $
 */
...
public class PacmanView extends ImageView {
	public PacmanView(Viewport inviewport) {
		...
		final String[] files = { "pacman/up1.gif", "pacman/up2.gif",
				"pacman/up3.gif", "pacman/up4.gif", "pacman/down1.gif",
				"pacman/down2.gif", "pacman/down3.gif", "pacman/down4.gif",
				"pacman/left1.gif", "pacman/left2.gif", "pacman/left3.gif",
				"pacman/left4.gif", "pacman/right1.gif", "pacman/right2.gif",
				"pacman/right3.gif", "pacman/right4.gif" };
		getImages(files);
	}
	...
	public void render(Graphics g, GameElement ge, float delta) {
		...
		g.drawImage(getImage(pm, delta), margin
				+ (int) Math.round(pm.getX() * MazeCell.SIZE), margin
				+ (int) Math.round(pm.getY() * MazeCell.SIZE), viewport);
	}
