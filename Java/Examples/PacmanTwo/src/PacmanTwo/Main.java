 ...
 * @version $Id: Main.java 2663 2006-11-12 22:24:53Z elmuerte $
 */
package PacmanTwo;

/*
 * Possible concerns: scoring sound strategy bonus pickups (cherry) "dead ghost"
 * alternative leves save state? multiplayer?
 */
 ...
 * 
 * The following commandline arguments are accepted: --fps n set the FPS cap to
 * n frames --ghosts n set the number of ghosts to n
 */
