...
public class DotNETLOLA extends LOLA
{
  ...
  public void initPrologEngine(CommonResources resources, String generatedPredicatesFilename) throws ModuleException
  {
    ...
    String prologLibraryFilename = FileUtils.fixFilename(resources.ProjectConfiguration.getProperty("ComposestarPath") + "binaries/prolog/lib.pro");
    String prologConnectorFilename = FileUtils.fixFilename(resources.ProjectConfiguration.getProperty("ComposestarPath") + "binaries/prolog/connector.pro"); 
